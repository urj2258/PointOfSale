        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email"
              className="w-full px-4 py-2.5 rounded-input bg-white/20 dark:bg-white/[0.08] border border-white/40 dark:border-white/[0.12] text-sm text-brand-text-primary placeholder:text-brand-text-muted outline-none focus:border-brand-primary focus:bg-white/30 dark:focus:bg-white/[0.12] transition-colors caret-brand-primary" />
          </div>
