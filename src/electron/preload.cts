...
contextBridge.exposeInMainWorld('electron', {
  ...
  vendorLedger: {
    ...
    update: (id: string, paidAmount: number, description?: string, vehicleNumber?: string) => ipcRenderer.invoke('vendor-ledger:update', id, paidAmount, description, vehicleNumber),
  ...
  customerLedger: {
    ...
    update: (id: string, paidAmount: number, description?: string, vehicleNumber?: string) => ipcRenderer.invoke('customer-ledger:update', id, paidAmount, description, vehicleNumber),
